...
export default function LessonPage() {
  ...
  const tabs = ['Resume', 'Videos YouTube', 'Audio oral', 'Notes', 'Ressources', 'Exercices'].filter((item) => item !== 'Audio oral' || lesson.audio_script || lesson.oral_practice);
  ...
  return <AppShell><div className="page lesson-page"><PageHeader title="Lecon" back />
    ...
    <section className="lesson-content-grid">
      <main className="lesson-main-content">
        ...
        {tab === 'Videos YouTube' && <LessonVideos lesson={lesson} />}
