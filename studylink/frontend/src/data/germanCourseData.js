...
const lessonKinds = [
  { suffix: 'input', type: 'audio', title: 'Hoeren und Aussprache trainieren', minutes: 25, goal: 'Hoeren, nachsprechen, Betonung erkennen und nuetzliche Sprachbausteine aktivieren.' },
  { suffix: 'grammar', type: 'text', title: 'Grammatik und Anwendung vertiefen', minutes: 30, goal: 'Das Grammatikmuster verstehen und in kontrollierten Beispielen anwenden.' },
  { suffix: 'practice', type: 'exercise', title: 'Anwendungsuebungen und Transfer', minutes: 40, goal: 'Wortschatz und Grammatik in realistischen kommunikativen Aufgaben einsetzen.' },
  { suffix: 'quiz', type: 'quiz', title: 'Quiz und muendlicher Checkpoint', minutes: 20, goal: 'Verstehen pruefen, Fehler korrigieren und eine kurze muendliche Antwort produzieren.' },
];
...
export const germanCourseFallback = {
  ...
  modules: levelData.map((level, levelIndex) => ({
    id: `de-${level.cefr.toLowerCase()}`,
    title: level.title,
    description: `${level.focus}. Ziele: ${level.outcomes.join(' | ')}`,
